...
class Person private (val name: String) {
  ...
  /** @return
    *   a string representation of this person which just shows the name
    */
...
object Person {
  ...
  /** Creates an instance of Person without performing any validations. Should
  ...
  /** TODO #3d: Create a validated instance of Person. There are three
    * validations:
